...
# ============================================================
# Batch MD: pairwise_prodrug_polymer_MD
# Restart order:
# MD.gro -> skip
...
ROOT="$SCRIPT_DIR/pairwise_prodrug_polymer_MD"

if [ ! -d "$ROOT" ]; then
    echo "ERROR: pairwise_prodrug_polymer_MD not found."
    exit 1
fi
...
do
    ...
    do
        ...
        if [ "$start_stage" -le 2 ]; then
            echo "[2] editconf"
            $GMX editconf                 -f polymerdrug.pdb                 -o polymerdrug.gro                 -box 8 8 8                 -c
...
echo
echo "============================================================"
echo "pairwise_prodrug_polymer_MD batch finished."
