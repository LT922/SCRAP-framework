...
#    gmx grompp -f em_real.mdp -c sol.gro -p topol.top -n index.ndx -o em.tpr -maxwarn 2 && gmx mdrun -v -deffnm em
    ...
    gmx grompp -f NVT.mdp -c em.gro -p topol.top -n index.ndx -o NVT.tpr -maxwarn 2 && gmx mdrun -ntmpi 1 -ntomp 12 -pin on -deffnm NVT -nb gpu -v && gmx grompp -f NPT.mdp -c NVT.gro -t NVT.cpt -p topol.top -n index.ndx -o NPT.tpr -maxwarn 2 && gmx mdrun -ntmpi 1 -ntomp 12 -pin on -deffnm NPT -nb gpu -v && gmx grompp -f MD.mdp -c NPT.gro -t NPT.cpt -p topol.top -n index.ndx -o MD.tpr -maxwarn 2 && gmx mdrun -ntmpi 1 -ntomp 12 -pin on -deffnm MD -nb gpu -v
